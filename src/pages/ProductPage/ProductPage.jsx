...
<div className={styles.input_search}>
    <button className={styles.open_button} onClick={()=>toggleDrawer()}>{isOpen?<GrClose/>:<FcClearFilters size={15}/>}</button>
<input type={'search'} placeholder='Search Here...'/>

</div>
    <div className={isOpen===false? styles.child_div1:styles.child_divopen }>
      ...
      <label>
                  <p>Gender</p>  
                    <div>
                        <input type="checkbox" value="Men" onChange={handleGenderChange} /> Men
                    </div>
                    <div style={{width:100}}>

                        <input type="checkbox" value="Women" onChange={handleGenderChange} /> Women
                    </div>
      ...
      <label>
                   <p>Price</p> 
                   <div>
                        <input type="checkbox"  onChange={() => handleFilterChange('all')}   /> All
                    </div>
                    <div>
                        <input type="checkbox"   onChange={() => handleFilterChange('0-250')}   /> 0-250
                    </div>
                    <div style={{width:100}}>

                        <input type="checkbox" onChange={() => handleFilterChange('251-450')} /> 251-450
                    </div>
                    <div>

                        <input type="checkbox" onChange={() => handleFilterChange('above450')} /> Above 450
                    </div>
                    </label>
      </div>
      <div className={styles.filter_divs}>
      <label>
                 <p>Type </p>  
                    <div>
                        <input type="checkbox" value="Polo" onChange={handleTypeChange} /> Polo
                    </div>
                    <div style={{width:100}}> 

                        <input type="checkbox" value="Hoodie" onChange={handleTypeChange} /> Hoodie
                    </div>
                    <div>

                        <input type="checkbox" value="Basic" onChange={handleTypeChange} /> Basic
                    </div>
                    </label>
      </div>
    </div>
    ...
    <div className={styles.child_div2}>
     ...
     <div><p>Type:</p><p>{el.type}</p></div>
     <div><p>Color:</p><p>{el.color}</p></div>
     <div><p>Gender</p><p>{el.gender}</p></div>
     <div><p>Price</p><h5>MRP: ₹ {el.price}</h5></div>
     <div><button   onClick={()=>AddToCart(el)}>Add To Cart</button></div>
     {/* <div> <button onClick={() => AddToCart(el)}>
     <div>
